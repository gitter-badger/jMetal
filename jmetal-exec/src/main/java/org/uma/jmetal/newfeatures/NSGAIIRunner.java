...
public class NSGAIIRunner {
  ...
  public static void main(String[] args) throws JMetalException {
    ...
    if (args.length == 1) {
      ...
      problemName = "org.uma.jmetal.problem.multiobjective.zdt.ZDT11";
    }

    problem = ProblemUtils.loadProblem(problemName);
    //MultithreadedProblem2<DoubleSolution> multithreadedProblem = new MultithreadedProblem2(problem) ;
